- dashboard: 4__dashboard_perf_lookup
  ...
  - title: Cache Ratio Comparison
    ...
    fields:
    - history.real_dash_id
    - history.count_query_run_cache
    - history.count_query_run_no_cache
    - history.query_run_count
    filters:
    ...
    - label: ''
      ...
      valueFormat:
      series:
      - id: history.count_query_run_cache
        name: History Query Run Count From Cache
        axisId: history.count_query_run_cache
      - id: history.count_query_run_no_cache
        name: History Query Run Count Without Cache
        axisId: history.count_query_run_no_cache
    - label:
      maxValue:
      minValue:
      orientation: right
  ...
  - title: Filter Values
    ...
    filters:
    sorts:
    - history.count_query_run_no_cache desc
    limit: 500
    column_limit: 50
    dynamic_fields:
    ...
    series_types: {}
    series_labels:
      history.count_query_run_no_cache: Uncached
      history.count_query_run_cache: Cached
    hidden_fields:
    - dashboard_filters.filter_json
    conditional_formatting:
    - type: low to high
